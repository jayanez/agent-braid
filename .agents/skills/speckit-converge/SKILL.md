...
Run `python3 .specify/scripts/python/check_prerequisites.py --json --require-tasks --include-tasks`. Compare implementation and obtained evidence with each requirement,
