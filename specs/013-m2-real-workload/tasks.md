...
- [x] T001 (REQ-001/SC-043–044): specify the draft experiment and proposed
  ADR 0015; add the read-only immutable-corpus preflight and negative tests.
- [x] T002 (REQ-001/SC-043–044): register two or three actual reviewed
  workstream PR commits from one frozen `develop` base and verify their
  declared footprints and preflight result.
- [x] T003 (REQ-002/SC-045–046): obtain separate founder acceptance of the exact
  corpus, frozen base, image digest and dependency set before executing
  project code.
- [x] T004 (REQ-002/SC-045–046): implement the isolated candidate/serial unit-test
